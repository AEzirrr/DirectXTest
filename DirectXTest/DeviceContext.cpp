...
void DeviceContext::setRasterizerState(RasterizerState* rasterizer_state) // sets and bind the rasterizer state to the device context
{
	if (rasterizer_state)
	{
		rasterizer_state->SetRasterizer(this->m_device_context);
	}
}

void DeviceContext::clearRasterizerState(RasterizerState* rasterizer_state) // clears rasterizer state
{
	if (rasterizer_state)
	{
